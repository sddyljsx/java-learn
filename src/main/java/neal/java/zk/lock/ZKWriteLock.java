 ...
 */
public class ZKWriteLock extends ProtocolSupport {
    private static final Logger LOG = LoggerFactory.getLogger(ZKWriteLock.class);
     ...
     */
    public ZKWriteLock(ZooKeeper zookeeper, String dir, List<ACL> acl) {
        super(zookeeper);
        this.dir = dir;
        if (acl != null) {
            setAcl(acl);
    ...
    public synchronized void unlock() throws RuntimeException {
        ...
        if (!isClosed() && id != null) {
            ...
            try {
                ...
                ZKOperation zopdel = new ZKOperation() {
     ...
     */
    private class LockZooKeeperOperation implements ZKOperation {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ZKWriteLock zkWriteLock = new ZKWriteLock(zk, "/zk", ZooDefs.Ids.OPEN_ACL_UNSAFE);
        System.out.println(zkWriteLock.lock());
    }
}
