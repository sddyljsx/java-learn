...
object NonVariance {
  def main(args: Array[String]): Unit = {
    ...
    val app_domain = List("584e5c69efc47",
      "587c6ed11d72b",
      "58eb2ead71ba0",
      "595f47fd24aab",
      "595f48107fed6",
    ...
    // val map4 = ListMap(map.toSeq.sortBy(_._1): _ *)

    // println(map4)

    // println(web_map.filterKeys(x => web_domain.contains(x)).values.sum)
